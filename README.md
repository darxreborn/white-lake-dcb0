...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/white-lake-dcb0)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/white-lake-dcb0
```

A live public deployment of this template is available at [https://white-lake-dcb0.templates.workers.dev](https://white-lake-dcb0.templates.workers.dev)
